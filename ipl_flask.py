...
@app.route('/')
def home():
    return render_template('ipl_index.html')
...
def predict():
    if request.method == 'POST':
        ...
        return render_template('ipl.html', batting_team=batting_team, bowling_team=bowling_team, win_probability=win_probability, loss_probability=loss_probability)
